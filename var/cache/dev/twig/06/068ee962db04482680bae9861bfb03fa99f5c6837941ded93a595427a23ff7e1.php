...
class __TwigTemplate_397d07b143452e7fa13041bf958470554911924914d90010ea9a8dd6e3d75d04 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 6
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 6, $this->source); })()), "pdf", [], "any", false, false, false, 6), 'row');
        echo "
";
    ...
    {
        return array (  60 => 6,  56 => 5,  52 => 4,  48 => 3,  43 => 1,);
    }
