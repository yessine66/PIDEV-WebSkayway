...
class __TwigTemplate_937d9751a64b26e0cd39aa969fa5abce63685e1b817843b8e0c602eff99659b1 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("cours_delete", ["idC" => twig_get_attribute($this->env, $this->source, (isset($context["cour"]) || array_key_exists("cour", $context) ? $context["cour"] : (function () { throw new RuntimeError('Variable "cour" does not exist.', 1, $this->source); })()), "idC", [], "any", false, false, false, 1)]), "html", null, true);
        echo "\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_token\" value=\"";
        // line 2
        echo twig_escape_filter($this->env, $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderCsrfToken(("delete" . twig_get_attribute($this->env, $this->source, (isset($context["cour"]) || array_key_exists("cour", $context) ? $context["cour"] : (function () { throw new RuntimeError('Variable "cour" does not exist.', 2, $this->source); })()), "idC", [], "any", false, false, false, 2))), "html", null, true);
        echo "\">
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('cours_delete', {'idC': cour.idC}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
