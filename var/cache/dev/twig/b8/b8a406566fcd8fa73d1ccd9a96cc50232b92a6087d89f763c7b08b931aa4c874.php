...
class __TwigTemplate_4bf36091178049d628ec2ec798f0e87815b657d013dbb1f57e16729fe4209985 extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    ...
    {% block content %}
        ...
        <button type=“button” class=\"button-create\"><a href=\"{{ path('reponse_index') }}\">back to list</a></button>
    ...
    {% endblock %}
{% endblock %}", "reponse/edit.html.twig", "C:\\wamp64\\www\\PIDEV-WebSkayway\\templates\\reponse\\edit.html.twig");
    }
}
