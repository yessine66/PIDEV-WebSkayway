...
class __TwigTemplate_bd22cc5a2d73fea90ba359dd21b2b5f1da34a5eb6cab617b0c717f02b96b666f extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("reclamation_delete", ["idRec" => twig_get_attribute($this->env, $this->source, (isset($context["reclamation"]) || array_key_exists("reclamation", $context) ? $context["reclamation"] : (function () { throw new RuntimeError('Variable "reclamation" does not exist.', 1, $this->source); })()), "idRec", [], "any", false, false, false, 1)]), "html", null, true);
...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('reclamation_delete', {'idRec': reclamation.idRec}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
