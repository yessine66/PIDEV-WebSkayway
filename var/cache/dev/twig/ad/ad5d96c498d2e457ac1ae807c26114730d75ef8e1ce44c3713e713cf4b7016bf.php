...
class __TwigTemplate_77dcb4de2b8201a84b1c9e4476e9f7e5c1c91b3343d52272ae5a0ecb2910cb19 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable(twig_array_merge((isset($context["options"]) || array_key_exists("options", $context) ? $context["options"] : (function () { throw new RuntimeError('Variable "options" does not exist.', 9, $this->source); })()), ["class" => "btn btn-secondary"]));
 ...
 */
#}
<a{% for attr, value  in options | merge({class: 'btn btn-secondary'})%} {{ attr }}=\"{{ value }}\"{% endfor %}>
<span class=\"float-right\">
        {% if sorted %}
            {% if direction == 'desc' %}
