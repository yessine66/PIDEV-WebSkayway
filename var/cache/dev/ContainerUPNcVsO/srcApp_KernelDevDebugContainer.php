...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolderc6fcc = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer1b8d2 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties134d5 = [
        
    ];

    public function getConnection()
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'getConnection', array(), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'getMetadataFactory', array(), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'getExpressionBuilder', array(), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'beginTransaction', array(), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'getCache', array(), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->getCache();
    }

    public function transactional($func)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'transactional', array('func' => $func), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->transactional($func);
    }

    public function commit()
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'commit', array(), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->commit();
    }

    public function rollback()
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'rollback', array(), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'getClassMetadata', array('className' => $className), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'createQuery', array('dql' => $dql), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'createNamedQuery', array('name' => $name), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'createQueryBuilder', array(), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'flush', array('entity' => $entity), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'clear', array('entityName' => $entityName), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->clear($entityName);
    }

    public function close()
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'close', array(), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->close();
    }

    public function persist($entity)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'persist', array('entity' => $entity), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'remove', array('entity' => $entity), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'refresh', array('entity' => $entity), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'detach', array('entity' => $entity), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'merge', array('entity' => $entity), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'getRepository', array('entityName' => $entityName), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'contains', array('entity' => $entity), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'getEventManager', array(), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'getConfiguration', array(), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'isOpen', array(), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'getUnitOfWork', array(), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'getProxyFactory', array(), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'initializeObject', array('obj' => $obj), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'getFilters', array(), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'isFiltersStateClean', array(), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'hasFilters', array(), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return $this->valueHolderc6fcc->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer1b8d2 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolderc6fcc) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolderc6fcc = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolderc6fcc->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, '__get', ['name' => $name], $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        if (isset(self::$publicProperties134d5[$name])) {
            return $this->valueHolderc6fcc->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolderc6fcc;
    ...
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;
    ...
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, '__isset', array('name' => $name), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;
    ...
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, '__unset', array('name' => $name), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;
    ...
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, '__clone', array(), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        $this->valueHolderc6fcc = clone $this->valueHolderc6fcc;
    }

    public function __sleep()
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, '__sleep', array(), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        return array('valueHolderc6fcc');
    }
    ...
    {
        $this->initializer1b8d2 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer1b8d2;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'initializeProxy', array(), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolderc6fcc;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolderc6fcc;
    }
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer1b8d2 && ($this->initializer1b8d2->__invoke($valueHolderc6fcc, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer1b8d2) || 1) && $this->valueHolderc6fcc = $valueHolderc6fcc;

        if ($this->valueHolderc6fcc === $returnValue = $this->valueHolderc6fcc->paginate($target, $page, $limit, $options)) {
            return $this;
        }
