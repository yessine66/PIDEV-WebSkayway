...
class ReponseController extends AbstractController
{
    ...
    /**
     * @Route("/{idR}", name="reponse_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idR}/edit", name="reponse_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{idR}", name="reponse_delete", methods={"POST"})
     */
    public function delete(Request $request, Reponse $reponse): Response
    {
        if ($this->isCsrfTokenValid('delete'.$reponse->getIdR(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
